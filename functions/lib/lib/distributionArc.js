...
exports.CADENCE_DAYS = exports.DISTRIBUTION_ARC = void 0;
exports.createDistributionArc = createDistributionArc;
exports.DISTRIBUTION_ARC = {
 ...
 */
function createDistributionArc(outputs, startDate) {
    if (outputs.length === 0)
        return [];
    ...
    for (const output of outputs) {
        const arcInfo = exports.DISTRIBUTION_ARC[output.platformId] ?? { day: 7, hour: 12, minute: 0 };
...
//# sourceMappingURL=distributionArc.js.map